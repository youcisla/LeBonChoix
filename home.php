...
<div class="containe-fluid">
	<div class="row mt-3 ml-3 mr-3">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <?php //echo "Bonjour ". $_SESSION['login_name']."!"  ?>
                    <hr>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                    ...
                    <h4><i class="fa fa-tags text-dark"></i> Tags</h4>
                    <div class="row">
                    <?php
                    ...
                    ?>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <p>
                                    <large><i class="fa fa-tag text-dark"></i> <b><?php echo $row['name'] ?></b></large>
                                </p>
                                <hr class="divider" style="max-width: 100%">
